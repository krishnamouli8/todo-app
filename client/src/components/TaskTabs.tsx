...
const TaskTabs = ({ activeTab, onTabChange, onAddClick }: TaskTabsProps) => (
  <div className="mb-6">
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <button
        onClick={onAddClick}
        className="flex items-center justify-center gap-2 px-4 py-2.5 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-colors w-full sm:w-auto"
      >
        <Plus className="w-5 h-5" />
        <span>Add Task</span>
      </button>
