  ...
  return (
    <div 
      ...
      <button
        ...
        className="fixed top-2 sm:top-4 left-2 sm:left-4 z-40 p-2 sm:p-3 bg-violet-600 rounded-full hover:bg-violet-700 transition-colors"
      >
        {isSidebarOpen ? (
      ...
      <main className="px-3 sm:px-4 py-4 sm:py-6">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-8 sm:mb-12 md:mb-16 mt-4 sm:mt-6 md:mt-8">
          <span className="text-violet-400 block sm:inline">User's</span>
          <span className="block sm:inline sm:ml-3">Todo List</span>
        </h1>

        <div className="max-w-2xl mx-auto px-2 sm:px-4">
          {error && (
            <div className="bg-red-900/50 border border-red-500/50 text-red-200 px-3 sm:px-4 py-2 sm:py-3 rounded-xl mb-4 text-sm sm:text-base">
              {error}
            </div>
          )}
